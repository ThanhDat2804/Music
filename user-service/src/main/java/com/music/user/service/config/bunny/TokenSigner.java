package com.music.user.service.config.bunny;
...
public class TokenSigner {
    ...
    public String signUrl(String urlIn, String securityKeyIn, String expirationTimeIn, String userIpIn,
        ...
        System.out.println( new String(Base64.encodeBase64(new DigestUtils("SHA-256").digest("e46cabad-fdc9-4c3a-873b-5f132f7085e01676245519".getBytes()))));
